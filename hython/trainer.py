    ...
    def epoch_step(self, model, dataloader, device, opt=None):
        ...
        for dynamic_b, static_b, targets_b in dataloader:
            ...
            for t in self.time_index:  # time_index could be a subset of time indices
                ...
                batch_temporal_loss += batch_sequence_los
...
class SimpleHydroTrainer(RNNTrainer):
    def __init__(self, params):
        super(SimpleHydroTrainer, self).__init__(params)
    ...
    def epoch_step(self, models:dict, device, opt=None):

        model_giuh = models["giuh"]
        model_land_surface = models["land_surface"]
        ...
        for dynamic_b, static_b, targets_b in dataloader:
            ...
            for t in self.time_index:  # time_index could be a subset of time indices
                ...
                output = model_land_surface(dynamic_bt, static_bt)
        ...
        land_surface_epoch_loss = running_batch_loss / data_points

        # FORWARD GIUH
        # get only giuh static, no forcings but states and fluxes 
        # I think I need to get runoff land and river +
        ...
        for t in range(self.P.time_range - self.P.seq_length):
            ...
            output = model_giuh(Xd_bt, xs_lumped)
